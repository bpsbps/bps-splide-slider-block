...
var Splide2 = class extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  render() {
    ...
    return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      ref: this.splideRef
    }, hasSliderWrapper ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "splide__slider"
    }, this.renderTrack()) : this.renderTrack(), hasAutoplayProgress && /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "splide__progress"
    }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "splide__progress__bar"
    })), hasAutoplayControls && /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "splide__autoplay"
    }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
      className: "splide__play"
    }, playButtonLabel), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
...
const divsToUpdate = document.querySelectorAll(".splide_element");
divsToUpdate.forEach(function (div) {
  const data = JSON.parse(div.querySelector("pre").innerHTML);
  react_dom__WEBPACK_IMPORTED_MODULE_2___default().render((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Slider, data), div);
  div.classList.remove("splide_element");
});

function Slider(props) {
  // Don't show empty items
  props.images = props.images.filter(function (image) {
    return image.id > 0;
  });
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_splidejs_react_splide__WEBPACK_IMPORTED_MODULE_3__.Splide, {
    options: {
      type: slider_options.type,
      rewind: slider_options.rewind,
      heightRatio: slider_options.height_ratio,
      gap: slider_options.gap + "px",
      padding: slider_options.padding + "%",
      breakpoints: slider_options.breakpoint == "" ? "" : {
        [slider_options.breakpoint]: {
          rewind: slider_options.rewind,
          type: slider_options.type,
          heightRatio: slider_options.breakpoint_height_ratio,
          gap: slider_options.breakpoint_gap + "px",
          padding: slider_options.breakpoint_padding + "%"
        }
      }
    }
  }, props.images.map(image => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_splidejs_react_splide__WEBPACK_IMPORTED_MODULE_3__.SplideSlide, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      className: "foobox",
      rel: "gallery",
      href: image.front_url
