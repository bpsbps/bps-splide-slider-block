...
/* harmony import */ var _block_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block.scss */ "./src/block.scss");
...
const __ = wp.i18n.__;
wp.blocks.registerBlockType("bps-blocks/slider", {
  title: "Splide " + __("slider", "bps-slider-block"),
  icon: "images-alt",
  category: "common",
  attributes: {
    images: {
  ...
  edit: function (props) {
    let items = props.attributes.images.map(value => value.id);
    const SortableItem = (0,react_sortable_hoc__WEBPACK_IMPORTED_MODULE_4__.SortableElement)(_ref => {
      let {
        value
      } = _ref;
      const imageObj = props.attributes.images.filter(image => image.id == value)[0];
      const imageIndex = props.attributes.images.map(element => element.id).indexOf(imageObj.id);
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.FlexItem, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
        className: "slider-edit-block-element"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.MediaUpload, {
        type: "image",
        value: imageObj.id,
        onSelect: imageObj => {
          const newImages = props.attributes.images.concat([]);
          newImages[imageIndex].id = imageObj.id;
          newImages[imageIndex].front_url = imageObj.url;
          newImages[imageIndex].block_url = imageObj.sizes.thumbnail.url;
          props.setAttributes({
            images: newImages
          });
        },
        render: obj => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.Button, {
          onClick: obj.open,
          style: {
            display: "inline-block"
          }
        }, imageObj.id ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("img", {
          src: imageObj.block_url,
          onClick: obj.open
        }) : __("Select image", "bps-slider-block")))
        ...
        onClick: () => {
          props.setAttributes({
            images: props.attributes.images.filter((item, index) => imageIndex !== index)
          });
        }
      }, __("Remove image", "bps-slider-block"))));
    });
    const SortableList = (0,react_sortable_hoc__WEBPACK_IMPORTED_MODULE_4__.SortableContainer)(_ref2 => {
      let {
        items
      } = _ref2;
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("ul", null, items.map((value, index) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(SortableItem, {
        key: `item-${value}`,
        index: index,
        value: value
      })));
    });
    const SortableImagesList = (0,react_sortable_hoc__WEBPACK_IMPORTED_MODULE_4__.SortableContainer)(_ref3 => {
      let {
        items
      } = _ref3;
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
        className: "slider-edit-block"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("h4", null, __("Slider images", "bps-slider-block"), ":"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.Flex, {
        justify: "flex-start",
        wrap: "true"
        ...
        onClick: () => {
          props.setAttributes({
            images: props.attributes.images.concat([{}])
          });
        }
      }, __("Add image", "bps-slider-block")));
    });

    class SortableComponent extends react__WEBPACK_IMPORTED_MODULE_3__.Component {
      constructor() {
        super(...arguments);
        ...
        (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "onSortEnd", _ref4 => {
          let {
            oldIndex,
            newIndex
          } = _ref4;
          const new_items = (0,react_sortable_hoc__WEBPACK_IMPORTED_MODULE_4__.arrayMove)(items, oldIndex, newIndex);
          this.setState(_ref5 => {
            let {
              items
            } = _ref5;
            return {
              items: (0,react_sortable_hoc__WEBPACK_IMPORTED_MODULE_4__.arrayMove)(items, oldIndex, newIndex)
            };
          });
          const newImages = props.attributes.images.concat([]);
          newImages.sort(function (a, b) {
            return new_items.indexOf(a.id) - new_items.indexOf(b.id);
          });
          props.setAttributes({
            images: newImages
          });
      ...
      render() {
        return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(SortableImagesList, {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(SortableComponent, null) // return (
    //   <div className="slider-edit-block">
    //     <h4>{__("Slider images", "bps-slider-block")}:</h4>
    //     <Flex className="bps-image-elements ui-sortable" justify="flex-start" wrap="true">
    //       {props.attributes.images.map(function (imageObj, imageIndex) {
    //         return (
    //           <FlexItem>
    //             <div className="slider-edit-block-element ui-sortable-handle">
    //               <MediaUpload
    //                 type="image"
    //                 value={imageObj.id}
    //                 onSelect={(imageObj) => {
    ...
    //                 render={(obj) => (
    //                   <div>
    //                     <Button onClick={obj.open} style={{ display: "inline-block" }}>
    //                       {imageObj.id ? <img src={imageObj.block_url} /> : __("Select image", "bps-slider-block")}
    //                     </Button>
    //                   </div>
    //                 )}
    //               />
    ...
    //                 isDestructive
    //                 onClick={() => {
    //                   props.setAttributes({ images: props.attributes.images.filter((item, index) => imageIndex !== index) });
    //                 }}
    //               >
    //                 {__("Remove image", "bps-slider-block")}
    //               </Button>
    ...
    //       isPrimary
    //       onClick={() => {
    //         props.setAttributes({ images: props.attributes.images.concat([{}]) });
    //       }}
    //     >
    //       {__("Add image", "bps-slider-block")}
    //     </Button>
